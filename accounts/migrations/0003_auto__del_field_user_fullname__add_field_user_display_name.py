...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.fullname'
        db.delete_column(u'accounts_user', 'fullname')

        # Adding field 'User.display_name'
        db.add_column(u'accounts_user', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User.fullname'
        db.add_column(u'accounts_user', 'fullname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'User.display_name'
        db.delete_column(u'accounts_user', 'display_name')
