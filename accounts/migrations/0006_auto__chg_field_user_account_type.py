...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.account_type'
        db.alter_column(u'accounts_user', 'account_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'User.account_type'
        db.alter_column(u'accounts_user', 'account_type', self.gf('django.db.models.fields.TextField')(null=True))
