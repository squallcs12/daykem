...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.account_type'
        db.alter_column(u'accounts_user', 'account_type', self.gf('django.db.models.fields.TextField')(default=None))

    models = {
        u'accounts.user': {
            'Meta': {'object_name': 'User'},
            'account_type': ('django.db.models.fields.TextField', [], {'null': 'True'}),
